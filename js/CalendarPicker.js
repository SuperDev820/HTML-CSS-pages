...
CalendarPicker.prototype._insertHeaderIntoCalendarWrapper = function () {
    ...
    CalendarPicker.prototype._insertNavigationButtons = function () {
        ...
        var arrowSvg1 = '<i class="fas fa-angle-left"></i>';
        var arrowSvg2 = '<i class="fas fa-angle-right"></i>';
    
        this.previousMonthArrow.innerHTML = arrowSvg1;
        this.nextMonthArrow.innerHTML = arrowSvg2;
        ...
        this.calendarHeader.appendChild(that.navigationWrapper);
    }
